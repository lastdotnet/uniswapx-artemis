...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ExclusivityLibErrors {
        const NAME: &'static str = "ExclusivityLibErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ExclusivityLibErrors>] = &[
                {
                    fn NoExclusiveOverride(
                        ...
                        <NoExclusiveOverride as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ExclusivityLibErrors::NoExclusiveOverride)
                    }
                    NoExclusiveOverride
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ExclusivityLib`](self) contract instance.

See the [wrapper's documentation](`ExclusivityLibInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ExclusivityLibInstance<T, P, N> {
        ExclusivityLibInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ExclusivityLibInstance<T, P, N>>,
    > {
        ExclusivityLibInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ExclusivityLibInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ExclusivityLib`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ExclusivityLib`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ExclusivityLibInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ExclusivityLibInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ExclusivityLibInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ExclusivityLibInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ExclusivityLibInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ExclusivityLibInstance<T, P, N> {
            ExclusivityLibInstance {

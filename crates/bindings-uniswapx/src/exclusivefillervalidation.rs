...
```solidity
interface ExclusiveFillerValidation {
    struct InputToken {
        address token;
        uint256 amount;
        uint256 maxAmount;
...
```*/
    ...
    /**Custom error with signature `NotExclusiveFiller(address)` and selector `0x75c1bb14`.
```solidity
error NotExclusiveFiller(address filler);
```*/
    #[allow(non_camel_case_types, non_snake_case)]
    ...
    const _: () = {
        ...
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<NotExclusiveFiller> for UnderlyingRustTuple<'_> {
            fn from(value: NotExclusiveFiller) -> Self {
                (value.filler,)
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>> for NotExclusiveFiller {
            fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                Self { filler: tuple.0 }
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolError for NotExclusiveFiller {
            type Parameters<'a> = UnderlyingSolTuple<'a>;
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "NotExclusiveFiller(address)";
            const SELECTOR: [u8; 4] = [117u8, 193u8, 187u8, 20u8];
            #[inline]
            fn new<'a>(
...
```*/
    ...
    impl ExclusiveFillerValidationCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[110u8, 132u8, 186u8, 43u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ExclusiveFillerValidationCalls {
        const NAME: &'static str = "ExclusiveFillerValidationCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ExclusiveFillerValidationCalls>] = &[
                {
                    fn validate(
                        data: &[u8],
                        validate: bool,
                        ...
                        <validateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ExclusiveFillerValidationCalls::validate)
                    }
                    validate
                },
            ];
    ...
    #[automatically_derived]
    impl ExclusiveFillerValidationErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
        ///
        /// Prefer using `SolInterface` methods instead.
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[117u8, 193u8, 187u8, 20u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ExclusiveFillerValidationErrors {
        const NAME: &'static str = "ExclusiveFillerValidationErrors";
        const MIN_DATA_LENGTH: usize = 32usize;
        const COUNT: usize = 1usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::NotExclusiveFiller(_) => {
                    <NotExclusiveFiller as alloy_sol_types::SolError>::SELECTOR
                }
            }
        }
        #[inline]
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ExclusiveFillerValidationErrors>] = &[
                {
                    fn NotExclusiveFiller(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<ExclusiveFillerValidationErrors> {
                        <NotExclusiveFiller as alloy_sol_types::SolError>::abi_decode_raw(
                                data,
                                validate,
                            )
                            .map(ExclusiveFillerValidationErrors::NotExclusiveFiller)
                    }
                    NotExclusiveFiller
                },
            ];
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::NotExclusiveFiller(inner) => {
                    <NotExclusiveFiller as alloy_sol_types::SolError>::abi_encoded_size(
                        inner,
                    )
                }
            }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::NotExclusiveFiller(inner) => {
                    <NotExclusiveFiller as alloy_sol_types::SolError>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
    ...
    /**Creates a new wrapper around an on-chain [`ExclusiveFillerValidation`](self) contract instance.

See the [wrapper's documentation](`ExclusiveFillerValidationInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ExclusiveFillerValidationInstance<T, P, N> {
        ExclusiveFillerValidationInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ExclusiveFillerValidationInstance<T, P, N>>,
    > {
        ExclusiveFillerValidationInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ExclusiveFillerValidationInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ExclusiveFillerValidation`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ExclusiveFillerValidation`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ExclusiveFillerValidationInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ExclusiveFillerValidationInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ExclusiveFillerValidationInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ExclusiveFillerValidationInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ExclusiveFillerValidationInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ExclusiveFillerValidationInstance<T, P, N> {

pub use mock_fee_controller_duplicates::*;
...
pub mod mock_fee_controller_duplicates {
    ...
    impl<M: ::ethers::providers::Middleware> MockFeeControllerDuplicates<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    MOCKFEECONTROLLERDUPLICATES_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                MOCKFEECONTROLLERDUPLICATES_ABI.clone(),
                MOCKFEECONTROLLERDUPLICATES_BYTECODE.clone().into(),
                client,
            );
    ...
    for MockFeeControllerDuplicates<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for MockFeeControllerDuplicatesCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for MockFeeControllerDuplicatesCalls {
    ...
    impl ::core::fmt::Display for MockFeeControllerDuplicatesCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<FeeRecipientCall> for MockFeeControllerDuplicatesCalls {
        fn from(value: FeeRecipientCall) -> Self {
            Self::FeeRecipient(value)
        }
    }
    impl ::core::convert::From<FeesCall> for MockFeeControllerDuplicatesCalls {
        fn from(value: FeesCall) -> Self {
            Self::Fees(value)
        }
    }
    impl ::core::convert::From<GetFeeOutputsCall> for MockFeeControllerDuplicatesCalls {
        fn from(value: GetFeeOutputsCall) -> Self {
            Self::GetFeeOutputs(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for MockFeeControllerDuplicatesCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<SetFeeCall> for MockFeeControllerDuplicatesCalls {

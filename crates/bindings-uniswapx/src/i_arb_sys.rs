...
pub mod i_arb_sys {
    ...
    pub static IARBSYS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IArbSys<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IArbSys<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IArbSys)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IArbSys<M> {

  ...
  constructor(scope: Construct, id: string, props: BackendProps) {
    ...
    const mainContainer = taskDefinition.addContainer(`${id}-backend`, {
      ...
      command: [
        "/bin/sh",
        "-c",
        "/app/uniswapx-artemis --wss $WS_RPC_URL --private-key $PRIVATE_KEY --bid-percentage $BID_PERCENTAGE --executor-address $EXECUTOR_ADDRESS --chain-id $CHAIN_ID --order-type $ORDER_TYPE",
      ],
